...
interface Props {
  ...
  onSubmit: (item: PicohiStockItem) => void;
}

export default function PicohiIntakeForm({ open, onOpenChange, onSubmit }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle>รับเครื่อง Picohi เข้า Stock</DialogTitle>
        </DialogHeader>
