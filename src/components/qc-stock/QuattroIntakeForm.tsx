...
interface Props {
  ...
  onSubmit: (item: QuattroStockItem) => void;
}

export default function QuattroIntakeForm({ open, onOpenChange, onSubmit }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle>รับเครื่อง Quattro เข้า Stock</DialogTitle>
        </DialogHeader>
