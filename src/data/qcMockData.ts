export type QcStatus = 'QC_PASSED' | 'QC_FAILED' | 'PENDING_QC';
export type StockStatus = 'READY_TO_SELL' | 'RESERVED' | 'INSTALLED' | 'SENT_FOR_REPAIR';
...
export const mockND2Stock: ND2StockItem[] = [
  ...
  },
  {
    ...
    clinic: '',
    qcResult: 'QC_FAILED',
    qcFailReason: 'HFL handpiece ไม่ทำงาน',
    notes: 'ส่งซ่อมกลับโรงงาน',
