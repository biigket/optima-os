...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `คุณเป็นผู้ช่วยวิเคราะห์การสนทนาขายอุปกรณ์การแพทย์/ความงาม ให้วิเคราะห์จากภาพแชทและโน้ตที่ให้มา แล้วสรุปเป็นภาษาไทยตามหัวข้อดังนี้:

1. **สนใจอะไร** - ลูกค้ากำลังสนใจสินค้า/บริการอะไร
2. **ติดปัญหาอะไร** - อุปสรรคหรือข้อกังวลของลูกค้า
3. **ต้องการ Solution แบบไหน** - ลูกค้าต้องการแก้ปัญหาอย่างไร
4. **Urgency** - ระดับความเร่งด่วน (สูง/กลาง/ต่ำ) พร้อมเหตุผล
5. **ควร Follow Up** - สิ่งที่ควรทำต่อไป

ตอบกระชับ ใช้ bullet points ไม่ต้องมีคำนำ`;
