...
ตอบเป็น JSON เท่านั้น ไม่มีข้อความอื่น:
{
  ...
  "talking_points": ["จุดพูดคุยสั้นๆ เป็น bullet แต่ละข้อ 1 ประโยคกระชับ สูงสุด 5 ข้อ"],
...
- talking_points ต้องเป็นคำพูดสั้นกระชับที่เซลล์หยิบไปใช้คุยกับลูกค้าได้ทันที เจาะจงตามสถานการณ์`;
